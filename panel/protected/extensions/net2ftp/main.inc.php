...
// -------------------------------------------------------------------------
    ...
    $rdu = trim(NET2FTP_APPLICATION_ROOTDIR_URL);
    if (preg_match('/[\\\\\\/]$/', $rdu))       { $net2ftp_globals["application_rootdir_url"] = substr($rdu, 0, -1); }
    else                                        { $net2ftp_globals["application_rootdir_url"] = $rdu; }
	...
	$net2ftp_globals["application_tempdir"]      = $net2ftp_globals["application_rootdir"] . "/../../runtime/net2ftp/";
    if (!file_exists($net2ftp_globals["application_tempdir"]))
        @mkdir($net2ftp_globals["application_tempdir"]);

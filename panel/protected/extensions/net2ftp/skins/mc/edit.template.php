...
<?php			if ($net2ftp_globals["state2"] == "") { ?>
				...
				<?php echo Yii::t('mc', "File: "); ?><?php echo $dirfilename; ?><br />
...
<?php				}
			...
			elseif ($net2ftp_globals["state2"] == "newfile") { ?>
				<?php echo Yii::t('mc', "New file name: "); ?><input class="input" type="text" name="entry" />
<?php			} ?>
...
<?php	  		printActionIcon("save", "document.forms['" . $formname . "'].screen.value=3;" . $codepress_onclick . "document.forms['" . $formname . "'].submit();", ""); ?> &nbsp; 
	...
	<tr>
		<td colspan="1" style="vertical-align: top; text-align: <?php echo __("left"); ?>;">

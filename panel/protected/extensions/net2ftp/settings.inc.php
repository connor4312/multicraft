...
if ($upload)
    $net2ftp_settings["max_filesize"] = $upload;
$net2ftp_settings["max_post_size"] = return_bytes(@ini_get("post_max_size"));
...
$net2ftp_settings["application_version"] = "0";
$net2ftp_settings["application_build_nr"] = "0";
